...
import com.yeahbutstill.javawebservlet.model.SayHelloRequest;
import com.yeahbutstill.javawebservlet.utils.JsonUtil;
...
public class ApiServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sayHello = "Hello, " + sayHelloRequest.getUsername() + " " + sayHelloRequest.getPassword();
